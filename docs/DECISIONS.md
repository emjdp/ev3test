...
| `MARKER_UTURN` | Stage 4/5 반사광 게이트에서 보라/RGB 또는 빨강 색상코드를 확정해 자동 180도 회전을 트리거 | marker, marker_source, candidate_kind, reflect, bits, color_code, center_reflect_avg, rgb_ratio |
